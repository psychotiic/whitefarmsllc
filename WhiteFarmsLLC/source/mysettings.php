...
<body>
	...
	if(!empty($err))  {
      ...
      <form action="mysettings.php" method="post" name="myform" id="myform">
		...
		<li><h2><strong>Current Registered Information</strong></h2><br/>
          <tr> 
		       <p>Here you can make changes to your profile. Please note that you will 
				not be able to change your email which has been already registered.</p><br/>
            <td colspan="2"><br/>
			Name:&nbsp;<?php echo $row_settings['full_name']; ?><br/>		
			Country:&nbsp;<?php echo $row_settings['country']; ?><br/>
			Phone:&nbsp;<?php echo $row_settings['tel']; ?><br/>
			Fax:&nbsp;<?php echo $row_settings['fax']; ?><br/>
			Website:&nbsp;<?php echo $row_settings['website']; ?><br/>
			Username:&nbsp;<?php echo $row_settings['user_name']; ?><br/>
			Email:&nbsp;<?php echo $row_settings['user_email']; ?> <br/><br/></tr>
			<hr> <br/>
			<td colspan="2"><br/>
			<li><h2><strong>Change Registered Information</strong></h2><br/>
			<br/>Name<br> <input name="name" type="text" id="name"  class="required" value="" size="50">  <br/>
          </tr>
          <tr> 
            <td>Country</td>
	  ...
	  <?php } ?>
      <hr> <br/>
	  <li><h2><strong>Change Password</strong></h2><br/>
