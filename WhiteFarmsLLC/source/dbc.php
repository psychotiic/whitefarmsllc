...
define ("DB_HOST", "psychotiic2012.ps.funpicsql.de"); // set database host
define ("DB_USER", "mysql1172981"); // set database user
define ("DB_PASS","password"); // set database password
define ("DB_NAME","mysql1172981"); // set database name
