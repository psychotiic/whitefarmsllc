...
<html>
<head>
<title>Private Membership Registration/Signup Form</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
  ...
  <tr> 
	...
	?></p>
      ...
      <p>Please register a free account, once an admininistrator approves your account you may access the site. 
        ...
        <table width="95%" border="0" cellpadding="3" cellspacing="3" class="forms">
          ...
          <tr> 
            ...
            <td><input name="pwd" type="password" class="required password" minlength="5" id="pwd"> 
              <span class="example">** 5 Character minimum...</span></td>
          </tr>
          <tr> 
