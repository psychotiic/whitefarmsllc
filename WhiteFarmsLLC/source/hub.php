...
<div class="box">
    ...
    <div class="box-content">
        <p>
            <font color="red"><center><strong>Important Notice</strong></font>: 
			Failure to comply with all MMMP Rules WILL Result in a immediate 
			termination of your account! You will not be allowed to enter the 
			education center or grow store.  Comply wilh all of the law just as we do.
			<strong>THERE WILL BE NO EXCEPTIONS!</strong></center>
        </p>
    </div>
